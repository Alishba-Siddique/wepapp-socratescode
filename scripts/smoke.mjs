...
for(const [route,status,marker] of [['/',200,'A little practice.'],['/curriculum',200,'Your learning path.'],['/patterns',200,'Find the pattern.'],['/learn/a-running-total',200,'A running total'],['/progress',200,'Your progress, earned.'],['/learn/missing-lab',404,'This lab is not here.']]) {
 let passed=false;
